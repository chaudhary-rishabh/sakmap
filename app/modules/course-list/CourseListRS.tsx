...
export default function CourseListRS() {
    ...
    useEffect(() => {
        async function fetchCategories() {
            try {
                ...
                const filteredData = data.filter((category: any) => category.category_name === "Remote Sensing");
    ...
    const mergingName = (name: any) => {
        ...
        const route = `/courses/remote-sensing/${routeName}`;
        return route;
    }
