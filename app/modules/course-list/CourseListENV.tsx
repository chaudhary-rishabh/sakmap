...
export default function CourseListENV() {
    ...
    useEffect(() => {
        async function fetchCategories() {
            try {
                ...
                const filteredData = data.filter((category: any) => category.category_name === "Environment");
    ...
    const mergingName = (name: any) => {
        ...
        const route = `/courses/environment/${routeName}`;
        return route;
    }
            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                    {categories.map((category: any) => (
                        <Link key={category.category_name} href={mergingName(category.course_name)} className="group"> {/*change this category_name to course name*/}
