...
export default function CourseListGIS() {
    ...
    useEffect(() => {
        async function fetchCategories() {
            try {
                ...
                const filteredData = data.filter((category: any) => category.category_name === "Geographic Information Systems");
    ...
    const mergingName = (name: any) => {
        ...
        const route = `/courses/geographic-information-systems/${routeName}`;
        return route;
    }
