    ...
    return (
        <div id="accordion-open" data-accordion="open">
            <h2 id="accordion-open-heading-1">
                <button
                    type="button"
                    className="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-900 border border-b-0 border-gray-900 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-white dark:border-black dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white gap-3"
            ...
            >
                <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-white">
            ...
            <h2 id="accordion-open-heading-2">
                <button
                    type="button"
                    className="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white gap-3"
            ...
            <h2 id="accordion-open-heading-3">
                <button
                    type="button"
                    className="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white gap-3"
